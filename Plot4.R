...
###################################################    
# Plot topleft line plot; y = Global Active Power
...
##################################################
# Plot topright line plot; y = Voltage
plot(power$Voltage,
     type = "l", ylab = "Voltage", 
     xaxt = "n", 
     xlab = "datetime", 
...
axis(side = 1, at = c(1, 1440, 2880), labels = c("Thu", "Fri", "Sat"))
###################################################
# Plot botleft line plot; y = 3XSub_metering
plot(power$Sub_metering_1,
     type = "l", ylab = "Energy sub metering", 
     xaxt = "n", 
     xlab = "", 
     col = "black")
lines(power$Sub_metering_2, col = "orange")
...
###################################################
# Plot botright line plot; y = Global Reactive Power
